package com.ruialves.chirp.infra.push_notification
...
import com.ruialves.chirp.domain.model.PushNotificationSendResult
...
class FirebasePushNotificationService(
    ...
    fun initialize() {
        try {
            val serviceAccount = resourceLoader.getResource(credentialPath)
                        ...
                        DeviceToken.Platform.ANDROID -> {
                            setAndroidConfig(
                                AndroidConfig.builder()
                                    ...
                                    .setRestrictedPackageName("com.ruialves.chirp")
                                    .build()
                            )
                        }
    ...
    private fun BatchResponse.toSendResult(
        ...
        logger.debug(
            "Push notification sent. Succeeded ${succeeded.size}," +
