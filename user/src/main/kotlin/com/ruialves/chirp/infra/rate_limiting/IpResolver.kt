...
import com.ruialves.chirp.infra.config.NginxConfig
...
class IpResolver(
    ...
    fun getClientIp(request: HttpServletRequest): String {
        ...
        if (clientIp == null){
            ...
            if (nginxConfig.requireProxy){
                throw SecurityException("No valid IP in proxy headers")
            }
        }
    ...
    private fun validateAndNormalizeIp(ip: String, headerName: String, proxyIp: String): String? {
        ...
        return try {
            ...
            if (isPrivateIp(inetAddr.hostAddress)) {
                logger.debug("Private IP in $headerName: $trimmedIp from proxy")
            }
